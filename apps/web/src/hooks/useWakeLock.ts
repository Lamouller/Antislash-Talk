...
export function useWakeLock() {
  ...
  /**
   * Create HTML audio element with actual audio content
   * Using a data URI with actual audio data (not silence)
   */
  const createAudioElement = useCallback(() => {
    ...
    // Use a longer audio file with actual (very quiet) content
    // This is a 10-second MP3 with a very quiet 100Hz tone
    audio.src = 'data:audio/mp3;base64,';
