...
import { FilePlus, ListMusic, Clock, Users, Mic, BarChart3, Activity, Upload } from 'lucide-react';
      ...
      <div className="relative overflow-hidden pt-8 pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center flex-wrap justify-center gap-4 p-2 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
              <Link to="/tabs/record">
