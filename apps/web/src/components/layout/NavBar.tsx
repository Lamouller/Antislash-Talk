...
export default function NavBar() {
  ...
  return (
    <nav 
      className="bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl backdrop-saturate-150 border-b border-white/20 dark:border-gray-700/30 shadow-lg shadow-black/5 md:hidden fixed top-0 left-0 right-0 z-50"
